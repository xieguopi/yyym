...
/* ----------------------------------------------------------------- data */
const SPECS = [
  { id:'s1', name:'精品礼盒装', weight:'500g', price:69,  note:'1盒 · 约25颗 · 赠定制冰袋', tag:'人气' },
  { id:'s2', name:'双盒尝鲜装', weight:'1kg',  price:128, note:'2盒 · 约50颗 · 赠定制冰袋×2', tag:'划算' },
  { id:'s3', name:'家庭分享装', weight:'2kg',  price:238, note:'4盒 · 约100颗 · 赠保鲜泡沫箱', tag:'送礼' },
];
const DATES = [
...
/* a soft painterly seal/label */
function Eyebrow({children, accent}){
  return (
    <div style={{display:'inline-flex',alignItems:'center',gap:8,marginBottom:14}}>
      <span style={{width:18,height:1,background:accent,opacity:.6}}></span>
      <span style={{fontSize:11.5,letterSpacing:'.28em',color:accent,fontWeight:500,whiteSpace:'nowrap'}}>{children}</span>
    </div>
  );
}

Object.assign(window, { SPECS, DATES, Ico, useCountdown, Eyebrow });
